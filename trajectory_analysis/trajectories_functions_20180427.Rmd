...
* Value: 
    + `data.frame` containing the following columns:
        ...
        6. `lat`: A numeric value representing the centroids for the latitude of fixes corresponding to a specific visit of a location [Â°].
        7. `lon`: A numeric value representing the centroids for the longitude of fixes corresponding to a specific visit of a location [Â°].
...
locationsTracks <- function(trs,
  ...
  for(visit_i in c(1:length(order.campsite.vis))){
    ...
    centr.coords <- rbind(centr.coords, apply(trsSP@coords[order.campsite.vis[[visit_i]],], 2 ,mean))
...
FixesForDaysTrColl <- function(trscoll,
  ...
  clusterExport(cl = cl, varlist = list("exDataTracks", "FixesForDays"), envir=environment())
